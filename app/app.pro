...
SOURCES += \
    ...
    streaming/virtualdisplaylaunch.cpp \
...
HEADERS += \
    ...
    streaming/session.h \
    streaming/virtualdisplaylaunch.h \
...
libva {
    ...
    HEADERS += \
        ...
        streaming/video/ffmpeg-renderers/rfipolicy.h
}
libva-x11 {
...
isEmpty(VBT_DIAG_ENDPOINT): VBT_DIAG_ENDPOINT = https://crash-endpoint.crash-endpoint.workers.dev/v1/report
