...
public:
    ...
    bool isHdrOutputAvailable() const { return m_HdrOutputAvailable; }
...
private:
    ...
    bool m_HdrOutputAvailable = false;
    bool m_HdrDegradationWarned = false;
    bool m_ColorRangeMismatchWarned = false;
    int m_VideoFormat = 0;
